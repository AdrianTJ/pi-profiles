...
- Speak instead of typing with `Ctrl+q` (pi-dictate): toggle, talk, transcript
  lands in the editor for review before sending. Local whisper.cpp or cloud
  Whisper — see its README for backend setup.
